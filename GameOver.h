...
#include <SFML/Window/Window.hpp> /// inclui esta tmbn porque me lo pide el compilador (igualmente no anda)
// - no se en donde mas habria que incluirla, ni a GIResource.hpp -
