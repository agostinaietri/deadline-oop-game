...
InputText::InputText(const sf::Font &font, int size=30, sf::Color color=sf::Color::White){
...
void InputText::setEditable(bool value){ editable=value; }
//

void InputText::setSingleWord(bool value){ single_word=value; }
//
